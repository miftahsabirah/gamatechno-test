  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6">
    ...
    <div class="my-card bg-white rounded-2xl py-10 px-8 flex flex-col gap-y-4">
      <svg width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M32.0292 27.6V16.2917C32.0292 15.2375 31.1667 14.375 30.1125 14.375H24.5541" stroke="#640EF1"
          stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M27.4292 11.5L23.9792 14.375L27.4292 17.25" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
    ...
    <div class="my-card bg-white rounded-2xl py-10 px-8 flex flex-col gap-y-4">
      <svg width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          ...
          stroke="#640EF1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M19.6667 11.9792V15.8125" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
          stroke-linejoin="round" />
        <path d="M12 30.6667V34.5" stroke="#640EF1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M19.6667 30.6667V34.5" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
          stroke-linejoin="round" />
        <path d="M27.3333 13.8958H35" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
          stroke-linejoin="round" />
        <path d="M4.33334 23H42.6667" stroke="#640EF1" stroke-width="3" stroke-linecap="round"
          stroke-linejoin="round" />
        <path
